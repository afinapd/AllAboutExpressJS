...
const { getAllTransaction, addNewTransaction, updateTransaction, deleteTransaction } = require('../controllers/transaction.controller')
...
router.post('/', (req, res, next) => addNewTransaction(req, res, transactionService))
